          ...
          <div className="flex items-center justify-between">
            <AnimatePresence>
              {!sidebarCollapsed && (
                ...
                >
                  <h1 className="text-xl font-bold text-white">C-Suite</h1>
                  <p className="text-sm text-white/60">Console</p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            >
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent"
                />
              </div>
            </motion.div>
          )}
                  ...
                  >
                        ...
                        >
                          ...
                          {item.badge && (
                            <motion.div
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
                              className="bg-blue-500 text-white text-xs rounded-full px-2 py-0.5 min-w-[1.25rem] h-5 flex items-center justify-center"
                            >
                              {item.badge}
                            </motion.div>
                          )}
                    ...
                    {sidebarCollapsed && isHovered && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, x: -10 }}
                        className="absolute left-16 bg-gray-900 text-white px-3 py-2 rounded-lg shadow-lg z-50 whitespace-nowrap"
                      >
